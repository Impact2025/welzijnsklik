...
export default async function FamilieAgendaPage() {
  ...
  return (
    <div className="px-4 py-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-neutral-500 mt-0.5">Wat er gepland staat en waar hulp wordt gevraagd</p>
      </div>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 text-sm text-neutral-600">
                      ...
                      <span>{isOpen && vrij > 0 ? `Nog ${vrij} plek${vrij !== 1 ? "ken" : ""}` : `${h.aantalNodig} helper${h.aantalNodig !== 1 ? "s" : ""} nodig`}</span>
                    </div>
                  </div>
                  <AanmeldKnop
                    hulpId={h.id}

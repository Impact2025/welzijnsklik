  ...
  return (
    <div style={{ fontFamily: 'var(--font-outfit, Outfit, sans-serif)', color: '#191c1d', background: '#f8f9fa' }}>
      ...
      <main style={{ paddingTop: 64 }}>
          ...
          <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center" style={{ gap: 64 }}>
            ...
            <div className="flex-1 space-y-6" style={{ maxWidth: 600 }}>
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full"
                style={{ background: 'rgba(187,211,253,0.25)', border: '1px solid #bbd3fd' }}>
                <span style={{ fontSize: 13, fontWeight: 500, color: '#485f84', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                  Innovatie in de zorg
                </span>
              </div>

              <h1 style={{ fontSize: 'clamp(30px,5vw,48px)', fontWeight: 700, color: '#1D3557', lineHeight: 1.15, letterSpacing: '-0.02em' }}>
                Verbind vrijwilligers, cliënten en familie{' '}
                <span style={{ color: '#005e9f' }}>met één klik.</span>
              </h1>

              <p style={{ fontSize: 17, color: '#404751', lineHeight: '28px' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <a href="#contact"
                  ...
                  style={{ background: '#FFB800', color: '#1D3557', fontSize: 16, fontWeight: 700, padding: '14px 32px', borderRadius: 12, boxShadow: '0 8px 24px rgba(255,184,0,0.28)' }}>
                  Vrijblijvende demonstratie aanvragen
                  <ArrowRight size={18} />
                </a>
                <a href="#flows"
                  className="flex items-center justify-center gap-2 transition-all"
                  style={{ fontSize: 16, fontWeight: 600, color: '#005e9f', border: '2px solid #005e9f', padding: '14px 28px', borderRadius: 12 }}>
                  Bekijk het platform
                </a>
              </div>
            </div>
            ...
            <div className="flex-1 relative w-full" style={{ height: 'clamp(320px,45vw,560px)', minWidth: 0 }}>
              <div className="absolute -top-12 -right-12 w-64 h-64 rounded-full blur-3xl pointer-events-none"
                style={{ background: 'rgba(0,94,159,0.06)' }} />
              <div className="absolute -bottom-12 -left-12 w-64 h-64 rounded-full blur-3xl pointer-events-none"
                style={{ background: 'rgba(187,211,253,0.18)' }} />
              <div className="relative w-full h-full overflow-hidden"
                style={{ borderRadius: 28, border: '8px solid #fff', boxShadow: '0 12px 40px rgba(29,53,87,0.14)' }}>
                <img
              ...
              <div className="absolute bottom-5 -left-4 md:-left-8 flex items-center gap-4"
                style={{ background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(12px)', borderRadius: 16, padding: '12px 16px', boxShadow: '0 4px 20px rgba(29,53,87,0.10)', border: '1px solid rgba(192,199,211,0.3)', animation: 'float 3s ease-in-out infinite' }}>
                <div style={{ width: 44, height: 44, background: 'rgba(0,94,159,0.10)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <Heart size={20} color="#005e9f" />
                </div>
                <div>
                  <p style={{ fontSize: 14, fontWeight: 600, color: '#005e9f', lineHeight: '20px' }}>Nieuw geluksmoment!</p>
                  <p style={{ fontSize: 12, color: '#404751' }}>Bewoner Mevr. Janssen heeft genoten</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* ━━ Waarom Welzijnsklik ━━━━━━━━━━━━━━━━━━━━━━━ */}
        <section id="waarom" style={{ background: '#f3f4f5', padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px)' }}>
          <div className="max-w-[1440px] mx-auto">
            <div className="text-center" style={{ marginBottom: 56 }}>
              <p style={{ fontSize: 13, fontWeight: 500, color: '#485f84', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10 }}>
                Voor bestuurders, directie en coördinatoren
              </p>
              <h2 style={{ fontSize: 'clamp(22px,3vw,32px)', fontWeight: 700, color: '#1D3557', marginBottom: 12 }}>
                Waarom Welzijnsklik?
              </h2>
              <p style={{ fontSize: 16, color: '#404751', maxWidth: 580, margin: '0 auto', lineHeight: '24px' }}>
              ...
              {WHY.map((item, i) => {
                ...
                return (
                  <div key={item.title} ref={(el) => { cardRefs.current[idx] = el; }} data-card={idx}
                    ...
                    <div>
                      <h3 style={{ fontSize: 17, fontWeight: 600, color: '#1D3557', marginBottom: 8 }}>{item.title}</h3>
                      <p style={{ fontSize: 15, color: '#404751', lineHeight: '23px' }}>{item.body}</p>
                    </div>
                  </div>
                );
              })}
        ...
        <section id="flows" style={{ background: '#fff', padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px)' }}>
          <div className="max-w-[1440px] mx-auto">
            <div className="text-center" style={{ marginBottom: 56 }}>
              ...
              <p style={{ fontSize: 16, color: '#404751', maxWidth: 520, margin: '0 auto', lineHeight: '24px' }}>
                ...
                return (
                  <div key={flow.role} ref={(el) => { cardRefs.current[idx] = el; }} data-card={idx}
                    ...
                    <div className="flex items-center gap-3" style={{ marginBottom: 20 }}>
                      <div style={{ width: 52, height: 52, background: 'rgba(0,94,159,0.08)', borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                        <Icon size={26} color="#005e9f" />
                      </div>
                      <div>
                        <p style={{ fontSize: 11, fontWeight: 600, color: '#005e9f', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
                          {flow.sub}
                        </p>
                        <h3 style={{ fontSize: 19, fontWeight: 700, color: '#1D3557', lineHeight: '26px' }}>{flow.role}</h3>
                      </div>
                    </div>
                    <div style={{ height: 1, background: '#edeeef', marginBottom: 20 }} />
                    <p style={{ fontSize: 15, color: '#404751', lineHeight: '24px', flex: 1 }}>{flow.body}</p>
                    <div className="flex items-center gap-1" style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid #edeeef' }}>
                      <span style={{ fontSize: 14, fontWeight: 500, color: '#005e9f' }}>Meer weten</span>
                      <ChevronRight size={16} color="#005e9f" />
                    </div>
                  </div>
                );
              })}
        ...
        {/* ━━ Sectoren ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
        <section id="sectoren" style={{ background: '#f3f4f5', padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px)' }}>
          <div className="max-w-[1440px] mx-auto">
            <div className="text-center" style={{ marginBottom: 56 }}>
              <p style={{ fontSize: 13, fontWeight: 500, color: '#485f84', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10 }}>
              ...
              <p style={{ fontSize: 16, color: '#404751', maxWidth: 540, margin: '0 auto', lineHeight: '24px' }}>
              ...
              {SECTORS.map((s, i) => {
                ...
                return (
                  <div key={s.title} ref={(el) => { cardRefs.current[idx] = el; }} data-card={idx}
                    ...
                    <div style={{ width: 52, height: 52, background: 'rgba(0,94,159,0.08)', borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20 }}>
                      <Icon size={26} color="#005e9f" />
                    </div>
                    <h3 style={{ fontSize: 18, fontWeight: 700, color: '#1D3557', marginBottom: 20, paddingBottom: 20, borderBottom: '1px solid #edeeef' }}>
                      {s.title}
                    </h3>
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 16 }}>
                      <div>
                        <p style={{ fontSize: 11, fontWeight: 700, color: '#717783', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 6 }}>
                          Uitdaging
                        </p>
                        <p style={{ fontSize: 14, color: '#404751', lineHeight: '22px' }}>{s.problem}</p>
                      </div>
                      <div>
                        <p style={{ fontSize: 11, fontWeight: 700, color: '#005e9f', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 6 }}>
                          De Welzijnsklik-impact
                        </p>
                        <p style={{ fontSize: 14, color: '#404751', lineHeight: '22px' }}>{s.impact}</p>
                      </div>
                    </div>
                  </div>
                );
        ...
        <section style={{ padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px)' }}>
          <div className="max-w-[1440px] mx-auto">
            <div
              style={{ background: '#1D3557', borderRadius: 40, padding: 'clamp(40px,5vw,72px) clamp(24px,5vw,80px)' }}>
              <div className="text-center" style={{ marginBottom: 48 }}>
                <p style={{ fontSize: 13, fontWeight: 500, color: '#9fcaff', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10 }}>
                  Zinvol uitproberen
                </p>
                <h2 style={{ fontSize: 'clamp(22px,3vw,32px)', fontWeight: 700, color: '#fff', marginBottom: 12 }}>
                  Start slim: de Welzijnsklik Pilot
                </h2>
                <p style={{ fontSize: 16, color: '#b0c7f1', maxWidth: 580, margin: '0 auto', lineHeight: '26px' }}>
                ...
                {PILOT.map((step, i) => {
                  ...
                  return (
                    <div key={step.n} ref={(el) => { cardRefs.current[idx] = el; }} data-card={idx}
                      ...
                      <div style={{ width: 40, height: 40, background: '#FFB800', color: '#1D3557', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: 16, marginBottom: 20 }}>
                        {step.n}
                      </div>
                      <h3 style={{ fontSize: 17, fontWeight: 600, color: '#fff', marginBottom: 12 }}>{step.title}</h3>
                      <p style={{ fontSize: 14, color: '#b0c7f1', lineHeight: '22px' }}>{step.body}</p>
                    </div>
                  );
                })}
              </div>
              ...
              <div className="text-center" style={{ marginTop: 48 }}>
                <a href="#contact"
                  ...
                  style={{ background: '#FFB800', color: '#1D3557', fontSize: 16, fontWeight: 700, padding: '14px 36px', borderRadius: 12, boxShadow: '0 8px 24px rgba(255,184,0,0.25)' }}>
                  Vraag de pilot aan
                  <ArrowRight size={18} />
                </a>
              </div>
        ...
        <section id="contact" style={{ background: '#fff', padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px)' }}>
          <div className="max-w-[860px] mx-auto text-center">
            ...
            <h2 style={{ fontSize: 'clamp(22px,3vw,32px)', fontWeight: 700, color: '#1D3557', marginBottom: 40 }}>
              Contact
            </h2>
            ...
            <p style={{ fontSize: 16, color: '#404751', lineHeight: '26px', marginBottom: 16 }}>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 transition-all hover:-translate-y-0.5 active:scale-95"
              style={{ background: '#FFB800', color: '#1D3557', fontSize: 16, fontWeight: 700, padding: '16px 40px', borderRadius: 12, boxShadow: '0 8px 24px rgba(255,184,0,0.28)' }}>
